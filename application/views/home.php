...
<head>
	...
	<title>Patrick - vCard / Resume / CV Template SHARED ON THEMELOCK.COM</title>
	...
	<div class="page">
		...
		<div class="container">
			...
			<div class="card-inner card-started active" id="home-card">
				...
				<!-- Started Background -->
				<div class="slide" style="background-image: url(<?= base_url('template/assets/img/bg.jpg');?>);"></div>

				<div class="centrize full-width">
					<div class="vertical-center">

						<!-- Started titles -->
						<div class="title"><span>Bernand</span> Dayamuntari Hermawan</div>
						<div class="subtitle">
							I am
							<div class="typing-title">
								<p>a <strong>Web Developer.</strong></p>
								<p>a <strong>IT Enthusiast.</strong></p>
							</div>
						...
						<div class="content inner-top">
							<div class="row">
								<div class="col col-m-12 col-t-12 col-d-12 col-d-lg-12">
									...
									<div class="text">
										<p>
											<strong>Hello, I’m a Bernand</strong>, web-developer based on Jakarta.
											<br />
											I have a lot experience in web site building <br />
											and customization. Also I am good at <strong>html, css, <br />
												wordpress, php, node js, jquery, bootstrap.</strong>
										</p>
									</div>
									<div class="circle-bts">
										<a href="<?= base_url('dokumen/CV - Bernand Dayamuntari Hermawan.pdf');?>"><span><i
													class="icon la la-download"></i>Download CV</span></a>
										<a href="https://github.com/bernandotorrez"><i
												class="icon la la-github"></i></a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row service-items">
								...
								<div class="col col-m-12 col-t-6 col-d-6 col-d-lg-6">
									<div class="service-item card-box">
										...
										<p>
											Made with modern design like Bootstrap or Material css and suitable to any
											device.
										</p>
									</div>
								</div>
							...
							<div class="row">
								<div class="col col-m-12 col-t-6 col-d-6 col-d-lg-6">
									...
									<div class="resume-items card-box">
										...
										<div class="resume-item">
											<div class="name">PT. Graha Karya Informasi</div>
											<div class="date">2017 - 2018 <span>|</span> PHP Programmer.</div>
											<p>
												Collaborate with Back-End Team to Develop Web Aplication.
												<br />
												<a style="color: #5ac14e" target="_blank"
													href="<?= base_url('dokumen/Surat Referensi Graha - Bernand Dayamuntari Hermawan.pdf');?>">Surat
													Referensi
												</a>
											</p>
										</div>
								...
								<div class="col col-m-12 col-t-6 col-d-6 col-d-lg-6">
									...
									<div class="resume-items card-box">
										...
										<!-- resume item -->
										<div class="resume-item">
											<div class="name">Univsersitas Pembangunan Nasional "Veteran" Jakarta</div>
											<div class="date">2013 - 2017 <span>|</span> S1 - Sistem Informasi</div>
											<p>
												Bachelor's Degree in Computer Science (Information System) with GPA :
												3.64.
											</p>
										</div>
							...
							<div class="row">
								<div class="col col-m-12 col-t-6 col-d-6 col-d-lg-6">
									...
									<div class="resume-items card-box">
										...
										<!-- resume item -->
										<div class="resume-item">
											<div class="name">UKM Ju-Jitsu</div>
											<div class="date">2013 - Present <span>|</span> Anggota.</div>
											<p>
												Anggota UKM Ju-Jitsu Universitas Pembangunan Nasional "Veteran" Jakarta,
												2013 - Sekarang..
											</p>
										</div>
										...
										<!-- resume item -->
										<div class="resume-item">
											<div class="name">ORP Mahatma</div>
											<div class="date">2017 - Present <span>|</span> Anggota.</div>
											<p>
												Anggota senam pernafasan Mahatma.
											</p>
										</div>
									...
									<div class="resume-items card-box">
										...
										<div class="resume-item">
											...
											<p>
												...
												<br />
												<a style="color: #5ac14e" target="_blank"
													href="<?= base_url('dokumen/cert-1059-13662276.pdf');?>">
													Certificate
												</a>
											</p>
										</div>
										...
										<!-- resume item -->
										<div class="resume-item">
											<div class="name">HTML Fundamental</div>
											<div class="date">No Expired Data<span>|</span> by SoloLearn</div>
											<p>
												HTML Fundamental Certification issued by SoloLearn.

												<br />
												<a style="color: #5ac14e" target="_blank"
													href="<?= base_url('dokumen/cert-1014-13662276.pdf');?>">
													Certificate
												</a>
											</p>
										</div>
										...
										<!-- resume item -->
										<div class="resume-item">
											<div class="name">SQL Fundamental</div>
											<div class="date">No Expired Data<span>|</span> by SoloLearn</div>
											<p>
												SQL Fundamental Certification issued by SoloLearn.

												<br />
												<a style="color: #5ac14e" target="_blank"
													href="<?= base_url('dokumen/cert-1060-13662276.pdf');?>">
													Certificate
												</a>
											</p>
										</div>
										...
										<!-- resume item -->
										<div class="resume-item">
											<div class="name">JavaScripts Tutorial Course</div>
											<div class="date">No Expired Data<span>|</span> by SoloLearn</div>
											<p>
												JavaScripts Tutorial Course Certification issued by SoloLearn.

												<br />
												<a style="color: #5ac14e" target="_blank"
													href="<?= base_url('dokumen/cert-1024-13662276.pdf');?>">
													Certificate
												</a>
											</p>
										</div>
										...
										<!-- resume item -->
										<div class="resume-item">
											<div class="name">jQuery Tutorial Course</div>
											<div class="date">No Expired Data<span>|</span> by SoloLearn</div>
											<p>
												jQuery Tutorial Course Certification issued by SoloLearn.

												<br />
												<a style="color: #5ac14e" target="_blank"
													href="<?= base_url('dokumen/cert-1082-13662276.pdf');?>">
													Certificate
												</a>
											</p>
										</div>
									...
									<div class="box-item card-box">
										...
										<div class="desc">
											<a href="https://vimeo.com/97102654"
												class="name has-popup-video">Architecture</a>
											<div class="category">Video</div>
										</div>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col col-m-12 col-t-12 col-d-12 col-d-lg-12">
									<div class="box-item card-box">
										...
										<div class="desc">
											<a href="blog-post.html" class="name">By spite about do of do allow
												blush</a>
											<div class="category">Design</div>
										</div>
									</div>
